(function() {
    ...
    var ALL_OPTIONS = [
        ...
        {group: 1, name: "ファーブラ・ソール",     effects: {hp: 15, pp: 2, sAtk: 15, rAtk: 15, tAtk: 15, dex: 15, sDef: 15, rDef: 15, tDef: 15}},
        {group: 1, name: "アレス・ジ・ソール",     effects: {hp: 35, pp: 3, sAtk: 25, rAtk: 25, tAtk: 25}},
        ...
        {group: 5, name: "センテンス・アルマ",     effects: {hp: 20, pp: 3, sAtk: 20}},
        {group: 5, name: "センテンス・ティロ",     effects: {hp: 20, pp: 3, rAtk: 20}},
        {group: 5, name: "センテンス・マギア",     effects: {hp: 20, pp: 3, tAtk: 20}},
